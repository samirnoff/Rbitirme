...
#  geom_text(label=miktar, hjust = -0.3) +
  theme_classic() +
  ...
  theme(axis.text.x = element_text(angle = 60, face = "bold", vjust = 0.5, size = 10)) +
  ...
  scale_y_continuous(
    limits = c(2000,6000),
    breaks = seq(2000,6000, by = 200),
    labels = c("2000","200","400","600","800","3000","200","400","600","800","4000","200","400","600","800","5000","200","400","600","800","6000")
  ) +
  ...
  annotate(geom = "text", x = 1937.5, y = 2470, label = "2404", fontface = "bold") 