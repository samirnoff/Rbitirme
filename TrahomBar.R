...
grup <- factor(c(rep(c("Yatýrýlarak tedavi sayýsý", "Yapýlan ameliyat       \" "), each=length(yatak))),
               levels=c("Yatýrýlarak tedavi sayýsý", "Yapýlan ameliyat       \" "))
...
ggplot(data=data,aes(x=factor(zaman), y=deger, fill=grup, color=grup, alpha=grup)) +
  ...
  theme(plot.caption = element_text(hjust = 0.2, vjust = 130, face = "bold", size = 15)) +
  ...
  scale_x_discrete(breaks=c(1925,1926,1927,1928,1929,1930,1931,1932,1933,1934,1935,1936,1937))+ 
