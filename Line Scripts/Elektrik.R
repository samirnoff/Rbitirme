...
ggplot(elektrik) +
  ...
  annotate("text", x = 1929, y = 70000, label = "K U R U L M U Ş", angle = 13, size = 7, fontface = "italic") +
  annotate("text", x = 1939.7, y = 183000, label = "K U R U L A C A K", angle = 45, size = 6, fontface = "italic") +
  annotate("text", x = 1933.2, y = 0, label = "Y     I     L     L     A     R", size = 8, fontface = "bold.italic", vjust = 1.7)
